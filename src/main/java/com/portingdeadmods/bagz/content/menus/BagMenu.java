...
public class BagMenu extends AbstractContainerMenu {
    ...
    public BagMenu(int containerId, Inventory playerInventory, Container container) {
    ...
    public BagMenu(int i, Inventory inventory, RegistryFriendlyByteBuf registryFriendlyByteBuf) {
        this(i,inventory);
    }
